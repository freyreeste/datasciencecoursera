...
A common format for this document is a Word file. There should be a section called "Study design" that has . There is a section called "Code book" that describes each variable and its units.
